...
[here](https://github.com/BU-IE-360/spring21-ozdemirezgi/blob/gh-pages/files/HW1/IE360_HW1.R)

  The R markdown file of this homework can be found
[here](https://github.com/BU-IE-360/spring21-ozdemirezgi/blob/gh-pages/files/HW1/IE360_HW1.Rmd)
  
  Lastly, the data series that are worked on can be found
[here](https://github.com/BU-IE-360/spring21-ozdemirezgi/blob/gh-pages/files/HW1/IE360_HW1_Data.zip)
